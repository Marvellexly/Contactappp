...
class AppPage(tk.Frame):
	...
	def clicked_update_btn(self):
		...
		for feature in features:
			...
			button = tk.Button(self.detail_update_footer, text=feature, bg="white", fg="black", font=("Arial", 12, "bold"), bd=0, command=commands[index]) #, command=commands[features.index(feature)]
